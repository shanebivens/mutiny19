...
const translations = {
    en: {
        ...
        'submit.captainForged': '⚓ Captain-Forged Event',
        'submit.captainForgedHint': 'Check if this event is created & hosted by a founder (not a corporate sponsor, accelerator, or third-party organizer)',
    ...
    es: {
        ...
        'submit.placeholder': 'https://...',
        'submit.captainForged': '⚓ Evento Forjado por Capitanes',
        'submit.captainForgedHint': 'Marca si este evento es creado y organizado por un fundador (no un patrocinador corporativo, aceleradora u organizador externo)',
